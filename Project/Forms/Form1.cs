    ...
    public partial class Form1 : Form
    {
        ...
        private void GetAllRepairs()
        {
            using (DomofonContext db = new DomofonContext())
            {
                ...
                dataGridView1.Columns.Add("col0", "ID");
                dataGridView1.Columns.Add("col1", "DateRepairBegin");
                dataGridView1.Columns.Add("col2", "AdressId");
                dataGridView1.Columns.Add("col3", "Flat");
                dataGridView1.Columns.Add("col4", "DescriptionFromSub");
                dataGridView1.Columns.Add("col5", "DateRepairEnd");
                dataGridView1.Columns.Add("col6", "DescriptionFromServ");
                dataGridView1.Columns.Add("col7", "Status");
                dataGridView1.Columns.Add("col8", "SubscriberId");
                dataGridView1.Columns.Add("col9", "Comments");
